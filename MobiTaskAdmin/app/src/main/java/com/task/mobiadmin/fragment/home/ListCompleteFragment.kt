...
class ListCompleteFragment : ListLoadingBaseFragment() {
    private var listener: TabCountListener.CompleteTabCount? = null
...
//        }
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        listRV.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView?, dx: Int, dy: Int) {
                ...
                if (totalItems <= lastItem + 1 && !loading && getTasks(Const.TASK_COMPLETE)) {
                    loading = true
    ...
    fun setOnCountListener(listener: TabCountListener.CompleteTabCount) {
    ...
    override fun onSuccess(call: Call<*>?, `object`: Any?) {
        ...
        (baseActivity as MainActivity).completedTasks = totalRecords
