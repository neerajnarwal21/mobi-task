...
class ListOngoingFragment : ListLoadingBaseFragment() {
    private var listener: TabCountListener.OngoingTabCount? = null
...
//        }
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        listRV.addOnScrollListener(object : RecyclerView.OnScrollListener() {
            override fun onScrolled(recyclerView: RecyclerView?, dx: Int, dy: Int) {
                ...
                if (totalItems <= lastItem + 1 && !loading && getTasks(Const.TASK_START)) {
                    loading = true
    ...
    fun setOnCountListener(listener: TabCountListener.OngoingTabCount) {
    ...
    override fun onSuccess(call: Call<*>?, `object`: Any?) {
        ...
        (baseActivity as MainActivity).ongoingTasks = totalRecords
