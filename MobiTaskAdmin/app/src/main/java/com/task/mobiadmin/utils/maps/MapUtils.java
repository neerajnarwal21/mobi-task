package com.task.mobiadmin.utils.maps;
...
public class MapUtils {
    ...
    public static MapUtils with(Context context) {
    ...
    public String getAddressFromLatLng(double lat, double lang) {
    ...
    public String getEncodedUrl(Location location, int radiusMeters) {
        String pathString = "";
...
//                pathString = PolyUtil.encode(circlePoints);
//            }
//        }
        return pathString;
    }

    private ArrayList<LatLng> getCircleAsPolyline(Location center, int radiusMeters) {
    ...
    public double distanceBetweenTwoLocations(double initialLat, double initialLong,
                                              double finalLat, double finalLong) {
        int R = 6378000; // km (Earth radius)
    ...
    private JSONObject getJSONfromURL(String strUrl) {
